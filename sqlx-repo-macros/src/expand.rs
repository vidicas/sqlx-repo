...
impl Expander {
    ...
    fn where_clause(&self) -> WhereClause {
        ...
        parse_quote! (
            ...
            // Decodable Types
            for<'e> bool: sqlx::Type<D> + sqlx::Decode<'e, D>,
            ...
            for<'e> &'e chrono::NaiveDate: sqlx::Type<D> + sqlx::Encode<'e, D>,
            for<'e> &'e chrono::NaiveTime: sqlx::Type<D> + sqlx::Encode<'e, D>,
            for<'e> &'e serde_json::Value: sqlx::Type<D> + sqlx::Encode<'e, D>,

            // Encodable optional
            for<'e> Option<bool>: sqlx::Type<D> + sqlx::Encode<'e, D>,
            ...
            for<'e> Option<&'e chrono::NaiveDate>: sqlx::Type<D> + sqlx::Encode<'e, D>,
            for<'e> Option<&'e chrono::NaiveTime>: sqlx::Type<D> + sqlx::Encode<'e, D>,
